...
## Texturas de herramientas (12 items)

Prompt base común (sustituir `<TOOL_SHAPE>` y `<MATERIAL_DESC>` por fila de la tabla):

```
16x16 pixel art texture, Minecraft item icon style, <TOOL_SHAPE>, <MATERIAL_DESC>, flat colors, hard pixel edges, no anti-aliasing, no gradients, transparent background, diagonal tool head in the upper-right pointing down-left, wooden stick handle in the lower-left, matching the proportions of vanilla Minecraft pickaxe/shovel icons
```
...
| Tier | `<MATERIAL_DESC>` | Notas de paleta |
|---|---|---|
...
Handle (mango) en los 6: `plain oak wood stick handle, brown color, same as vanilla tool handles` (constante en los 12 prompts, no cambia por tier).

### Ejemplos completos (2 de 12, el resto sale de sustituir la tabla)

**Wooden Workhand Pickaxe**:
```
16x16 pixel art texture, Minecraft item icon style, a pickaxe with a wide triangular double-pointed head, head made of light oak wood planks, matte tan-brown color, flat colors, hard pixel edges, no anti-aliasing, no gradients, transparent background, diagonal tool head in the upper-right pointing down-left, plain oak wood stick handle in the lower-left, matching the proportions of vanilla Minecraft pickaxe/shovel icons
```

**Netherite Workhand Shovel**:
```
16x16 pixel art texture, Minecraft item icon style, a shovel with a flat rounded blade head, head made of dark netherite metal, near-black gunmetal with subtle purple-gray sheen, flat colors, hard pixel edges, no anti-aliasing, no gradients, transparent background, diagonal tool head in the upper-right pointing down-left, plain oak wood stick handle in the lower-left, matching the proportions of vanilla Minecraft pickaxe/shovel icons
```
...
- [ ] `assets/workhand_tools/textures/item/wooden_workhand_pickaxe.png`
- [ ] `assets/workhand_tools/textures/item/wooden_workhand_shovel.png`
- [ ] `assets/workhand_tools/textures/item/stone_workhand_pickaxe.png`
- [ ] `assets/workhand_tools/textures/item/stone_workhand_shovel.png`
- [ ] `assets/workhand_tools/textures/item/iron_workhand_pickaxe.png`
- [ ] `assets/workhand_tools/textures/item/iron_workhand_shovel.png`
- [ ] `assets/workhand_tools/textures/item/golden_workhand_pickaxe.png`
- [ ] `assets/workhand_tools/textures/item/golden_workhand_shovel.png`
- [ ] `assets/workhand_tools/textures/item/diamond_workhand_pickaxe.png`
- [ ] `assets/workhand_tools/textures/item/diamond_workhand_shovel.png`
- [ ] `assets/workhand_tools/textures/item/netherite_workhand_pickaxe.png`
- [ ] `assets/workhand_tools/textures/item/netherite_workhand_shovel.png`
