...
| Última versión publicada | `1.23.2` (CurseForge file ID 8762797) |
| Estado | ✅ Release estable 1.23.2 — every tool in the mod (incl. hoes) is now enchantable via the enchantable/* item tags |
...
- v1.23.2 — Fixed Workhand Hoes not being enchantable (added to enchantable/* tags + new #minecraft:hoes tag); every tool in the mod is now enchantable
