...
Workhand Tools is a Minecraft 1.21.1 (NeoForge) mod that adds upgraded pickaxes and shovels with area mining capabilities.
...
| Minecraft | 1.21.1 |
| NeoForge | 21.1.249+ |
| Vellumli | 0.0.0-beta.1+ (required for guide book) |
| Java | 21 |

## Installation

1. Install [NeoForge](https://neoforge.net/) for Minecraft 1.21.1.
2. Install [Vellumli](https://www.curseforge.com/minecraft/mc-mods/vellumli) (required for the in-game guide book).
