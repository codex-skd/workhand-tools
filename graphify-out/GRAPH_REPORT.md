...
## Corpus Check
- 132 files · ~17,649 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 208 nodes · 234 edges · 36 communities (34 shown, 2 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `adbc9a61`
...
Cohesion: 0.43
Nodes (3): AoEPatterns, BlockPos, Player

### Community 4 - "AoE Mode"
Cohesion: 0.18
Nodes (8): Override, AoEMode, CUBIC, FLAT, fromName(), getSerializedName(), depth(), StringRepresentable
...
Cohesion: 0.23
Nodes (8): EventBusSubscriber, RenderLevelStageEvent, AreaHighlighter, BlockPos, SubscribeEvent, Mod, ModContainer, WorkhandToolsClient
...
Cohesion: 0.25
Nodes (7): [1.0.0] - 2026-08-07, [1.1.0] - 2026-08-08, Changelog — Workhand Tools, Feature, Fix, Refactor, Technical
...
## Knowledge Gaps
- **72 isolated node(s):** `CUBIC`, `FLAT`, `GRADE_1`, `GRADE_2`, `GRADE_3` (+67 more)
